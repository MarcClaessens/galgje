...
public class SoundPlayer {
	...
	public void setSound(SoundType type, Sound sound) {
		switch (type) {
			case GUESS : setGuess(sound); break;
			case WON : setWon(sound); break;
			case LOST : setLost(sound); break;
			default : throw new IllegalArgumentException("Invalid sound type "  + type);
		}
	}
