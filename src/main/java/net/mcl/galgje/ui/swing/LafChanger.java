...
public final class LafChanger {
	private static final Logger LOG = Logger.getLogger(LafChanger.class);

	/**
	 * Constructor.
	 * 
	 * @param listener
	 *            - the object listening to LaF implementation changes.
	 */
	public LafChanger() {
	}

	/**
	 * Changes the look and feel and updates the configuration to the current
	 * LaF.
	 * 
