 ...
 * http://stackoverflow
 * .com/questions/3923129/get-a-list-of-resources-from-classpath-directory
...
public class ResourceList {
	...
	private static Collection<String> getResources(final String element, final Pattern pattern) {
		...
		final File file = new File(fileName(element));
		if (file.isDirectory()) {
	...
	private static String fileName(String element) {
