...
import marcclaessens.galgje.Game;
import marcclaessens.galgje.GameListener;
import marcclaessens.galgje.SoundPlayer;
import marcclaessens.galgje.ui.I18N;
...
public class GameUI extends JFrame implements GameListener {
	...
	private void initPanels() {
		final JPanel realContent = new JPanel(new MigLayout("align center", "[grow, fill]", "[]"));

		CollapsablePanel cKeyboardPanel = new CollapsablePanel(keyboardPanel, i18n.getShowKeyboard(),
				i18n.getHideKeyboard(), true);
		CollapsablePanel cOptionsPanel = new CollapsablePanel(optionsPanel, i18n.getShowOptions(),
				i18n.getHideOptions(), false);
		CollapsablePanel cprogressPanel = new CollapsablePanel(progressImagePanel, i18n.getShowProgress(),
				i18n.getHideProgress(), true);
